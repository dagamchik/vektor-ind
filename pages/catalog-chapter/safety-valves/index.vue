    ...
    <section class="catalog">
      <div class="container container__catalog">
        <div class="catalog__block">
          <div class="link__way">
            <nuxt-link to="/" class="main__link">Главная страница</nuxt-link> - <nuxt-link to="/catalog" class="catalog__link">Каталог</nuxt-link> - <p>Клапаны предохранительные</p>
          </div>
          <h2>Клапаны предохранительные</h2>
        </div>

        <div class="main__block">
          <filterBlockSafety :products="products" @updateProducts="doUpdate"/>
...
import filterBlockSafety from "@/components/filterBlockSafety.vue";
...
export default {
  ...
  methods: {
    fetchData() {
      this.$axios.$get(`/api/safety-valves`)
        .then((res) => {
          this.products = res;
