    ...
    <section class="catalog">
      <div class="container container__catalog">
        <div class="catalog__block">
          <div class="link__way">
            <nuxt-link to="/" class="main__link">Главная страница</nuxt-link> - <nuxt-link to="/catalog" class="catalog__link">Каталог</nuxt-link> - <p>Клапаны обратные</p>
          </div>
          <h2>Клапаны обратные</h2>
        </div>

        <div class="main__block">
          <filterBlockCheck :products="products" @updateProducts="doUpdate"/>
...
import filterBlockCheck from "@/components/filterBlockCheck.vue";
...
export default {
  ...
  methods: {
    fetchData() {
      this.$axios.$get(`/api/check-valves`)
        .then((res) => {
          this.products = res;
