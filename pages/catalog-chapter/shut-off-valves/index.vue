    ...
    <section class="catalog">
      <div class="container container__catalog">
        <div class="catalog__block">
          <div class="link__way">
            <nuxt-link to="/" class="main__link">Главная страница</nuxt-link> - <nuxt-link to="/catalog" class="catalog__link">Каталог</nuxt-link> - <p>Клапаны запорные</p>
          </div>
          <h2>Клапаны запорные</h2>
        </div>

        <div class="main__block">
          <filterBlockShutOff :products="products" @updateProducts="doUpdate"/>
...
import filterBlockShutOff from "@/components/filterBlockShutOff.vue";
...
export default {
  ...
  methods: {
    fetchData() {
      this.$axios.$get(`/api/shut-off-valves`)
        .then((res) => {
          this.products = res;
