    ...
    <section class="catalog">
      <div class="container container__catalog">
        <div class="catalog__block">
          <div class="link__way">
            <nuxt-link to="/" class="main__link">Главная страница</nuxt-link> - <nuxt-link to="/catalog" class="catalog__link">Каталог</nuxt-link> - <p>Регуляторы давления</p>
          </div>
          <h2>Регуляторы давления</h2>
        </div>

        <div class="main__block">
          <filterBlock :products="products" @updateProducts="doUpdate"/>
          <div class="right__main-block">
              ...
              <div class="sort__main">
                <div class="sort__main-left">
                  ...
                  <svg @click.prevent="changeView = !changeView" v-if="changeView === true" class="sort-tile" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="10" height="10" stroke="#606060" stroke-opacity="0.2" fill="#fff"/>
                    <rect x="12" width="10" height="10" stroke="#606060" stroke-opacity="0.2" fill="#fff"/>
                    <rect y="12" width="10" height="10" stroke="#606060" stroke-opacity="0.2" fill="#fff"/>
                    <rect x="12" y="12" width="10" height="10" stroke="#606060" stroke-opacity="0.2" fill="#fff"/>
                  </svg>
            ...
            <div class="cards__block">
              ...
              <!-- <pagination v-model="page" :count="products.length" :per-page="productsPerPage" :products="products" :pageNumber="pageNumber"/> -->
...
export default {
  ...
  methods: {
    fetchData() {
      this.$axios.$get(`/api/pressure-regulators`)
        .then((res) => {
          this.products = res;
