    ...
    <section class="catalog">
      <div class="container container__catalog">
        <div class="catalog__block">
          <div class="link__way">
            <nuxt-link to="/" class="main__link">Главная страница</nuxt-link> - <nuxt-link to="/catalog" class="catalog__link">Каталог</nuxt-link> - <p>Краны шаровые</p>
          </div>
          <h2>Краны шаровые</h2>
        </div>

        <div class="main__block">
          <filterBlockBall :products="products" @updateProducts="doUpdate"/>
...
import filterBlockBall from "@/components/filterBlockBall.vue";
...
export default {
  ...
  methods: {
    fetchData() {
      this.$axios.$get(`/api/ball-valves`)
        .then((res) => {
          this.products = res;
