    ...
    <section class="catalog">
      <div class="container container__catalog">
        <div class="catalog__block">
          <div class="link__way">
            <nuxt-link to="/" class="main__link">Главная страница</nuxt-link> - <nuxt-link to="/catalog" class="catalog__link">Каталог</nuxt-link> - <p>Клапаны регулирующие</p>
          </div>
          <h2>Клапаны регулирующие</h2>
        </div>

        <div class="main__block">
          <filterBlockControl :products="products" @updateProducts="doUpdate"/>
...
import filterBlockControl from "@/components/filterBlockControl.vue";
...
export default {
  ...
  methods: {
    fetchData() {
      this.$axios.$get(`/api/control-valves`)
        .then((res) => {
          this.products = res;
