    ...
    <section class="catalog">
      <div class="container container__catalog">
        <div class="catalog__block">
          <div class="link__way">
            <nuxt-link to="/" class="main__link">Главная страница</nuxt-link> - <nuxt-link to="/catalog" class="catalog__link">Каталог</nuxt-link> - <p>Задвижки</p>
          </div>
          <h2>Задвижки</h2>
        </div>

        <div class="main__block">
          <filterBlockGate :products="products" @updateProducts="doUpdate"/>
...
import filterBlockGate from "@/components/filterBlockGate.vue";
...
export default {
  ...
  methods: {
    fetchData() {
      this.$axios.$get(`/api/gate-valves`)
        .then((res) => {
          this.products = res;
