    ...
    <section class="catalog">
      <div class="container container__catalog">
        <div class="catalog__block">
          <div class="link__way">
            <nuxt-link to="/" class="main__link">Главная страница</nuxt-link> - <nuxt-link to="/catalog" class="catalog__link">Каталог</nuxt-link> - <p>Переключающие устройства</p>
          </div>
          <h2>Переключающие устройства</h2>
        </div>

        <div class="main__block">
          <filterBlockSwitching :products="products" @updateProducts="doUpdate"/>
...
import filterBlockSwitching from "@/components/filterBlockSwitching.vue";
...
export default {
  ...
  methods: {
    fetchData() {
      this.$axios.$get(`/api/switching-devices`)
        .then((res) => {
          this.products = res;
