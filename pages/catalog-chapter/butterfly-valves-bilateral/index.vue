    ...
    <section class="catalog">
      <div class="container container__catalog">
        ...
        <div class="main__block">
          <filterBlockButterflyBilateral :products="products" @updateProducts="doUpdate"/>
...
import filterBlockButterflyBilateral from "@/components/filterBlockButterflyBilateral.vue";
...
export default {
  ...
  components: {
    ...
    footerComponent,
    productChapter,
    filterBlockButterflyBilateral
  },
  methods: {
    fetchData() {
      this.$axios.$get(`/api/butterfly-valves-bilateral`)
        .then((res) => {
          this.products = res;
