  ...
  <div class="accordion" id="accordion">
    ...
    <div class="accordion-item">
      ...
      <div class="accordion-item-body">
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="principeDevice" value="Нормально закрытый"/>
            <i></i>
          </label>
          <span>Нормально закрытый</span>
        </div>
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="principeDevice" value="Нормально открытый"/>
            <i></i>
          </label>
          <span>Нормально открытый</span>
        </div>
      </div>
    </div>
    ...
    <div class="accordion-item">
      ...
      <div class="accordion-item-body">
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="typeDrive" value="Автоматический"/>
            <i></i>
          </label>
        ...
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="typeDrive" value="Грузо-рычажный механизм с МИМ"/>
            <i></i>
          </label>
          <span>Грузо-рычажный механизм с МИМ</span>
        </div>
      </div>
    </div>
  </div>
  ...
  methods: {
    ...
    checkArr() {
      ...
      let newArr = vm.$store.state.products.products[0].filter(function (item) {
        ...
        if (vm.principeDevice.length > 0) {
          conditions.push(vm.principeDevice.includes(item.principe_device));
        }
        if (vm.DN.length > 0) {
