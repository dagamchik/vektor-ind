  ...
  <div class="accordion" id="accordion">
    ...
    <div class="accordion-item">
      ...
      <div class="accordion-item-body">
        ...
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="DN" value="25/32"/>
            <i></i>
          </label>
          <span>25/32</span>
        </div>
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="DN" value="25/40"/>
            <i></i>
          </label>
          <span>25/40</span>
        </div>
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="DN" value="50/80"/>
            <i></i>
          </label>
          <span>50/80</span>
        </div>
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="DN" value="80/100"/>
            <i></i>
          </label>
          <span>80/100</span>
        </div>
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="DN" value="100/150"/>
            <i></i>
          </label>
          <span>100/150</span>
        </div>
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="DN" value="150/200"/>
            <i></i>
          </label>
          <span>150/200</span>
        </div>
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="DN" value="200/300"/>
            <i></i>
          </label>
          <span>200/300</span>
        </div>
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="DN" value="250/350"/>
            <i></i>
          </label>
          <span>250/350</span>
        </div>
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="DN" value="300/400"/>
            <i></i>
          </label>
          <span>300/400</span>
        </div>
    ...
    <div class="accordion-item">
      ...
      <div class="accordion-item-body">
        ...
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="PN" value="16/6"/>
            <i></i>
          </label>
          <span>16/6</span>
        </div>
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="PN" value="25/16"/>
            <i></i>
          </label>
          <span>25/16</span>
        </div>
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="PN" value="40/16"/>
            <i></i>
          </label>
          <span>40/16</span>
        </div>
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="PN" value="63/40"/>
            <i></i>
          </label>
          <span>63/40</span>
        </div>
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="PN" value="100/40"/>
            <i></i>
          </label>
          <span>100/40</span>
        </div>
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="PN" value="160/40"/>
            <i></i>
          </label>
          <span>160/40</span>
        </div>
    ...
    <div class="accordion-item">
      ...
      <div class="accordion-item-body">
        ...
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="connType" value="Штуцерно-торцевое"/>
            <i></i>
          </label>
    ...
    <div class="accordion-item">
      ...
      <div class="accordion-item-body">
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="dubler" value="Без приспособления для принудительного открытия"/>
            <i></i>
          </label>
        ...
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="dubler" value="С приспособлением для принудительного открытия"/>
            <i></i>
          </label>
        ...
        <div class="item">
          <label>
            <input type="checkbox" class="css-checkbox" v-model="dubler" value="Уравновешенного типа"/>
            <i></i>
          </label>
  ...
  methods: {
    ...
    checkArr() {
      ...
      let newArr = vm.$store.state.products.products[0].filter(function (item) {
        ...
        if (vm.dubler.length > 0) {
          conditions.push(vm.dubler.includes(item.dubler));
        }
