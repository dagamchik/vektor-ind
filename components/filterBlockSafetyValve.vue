    ...
    <div class="accordion-item">
      ...
      <div class="accordion-item-body">
        ...
        <div class="range-slider">
          <input type="range" min="0" max="3000000" step="100" v-model.number="minPrice" @change="setRangeSlider">
          <input type="range" min="0" max="3000000" step="100" v-model.number="maxPrice" @change="setRangeSlider">
        </div>
      </div>
    </div>
